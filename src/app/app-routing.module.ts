...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./miperfil/perfil.module').then((m) => m.PerfilPageModule),
  },
  {
    path: 'miscompras',
    loadChildren: () =>
      import('./miscompras/miscompras.module').then(
  ...
  },
  {
    path: 'apirest',
    loadChildren: () =>
      import('./apirest/apirest.module').then((m) => m.ApirestPageModule),
  },
  {
    path: 'contactos',
    loadChildren: () =>
